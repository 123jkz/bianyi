...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    SEMI = 277,                    /* SEMI  */
    KEY = 278,                     /* KEY  */
    SPACE_ENTER = 279,             /* SPACE_ENTER  */
    UNDEFINE = 280,                /* UNDEFINE  */
    DEC = 281,                     /* DEC  */
    HEX = 282,                     /* HEX  */
    OCT = 283,                     /* OCT  */
    ILHEX = 284,                   /* ILHEX  */
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_KEY = 23,                       /* KEY  */
  YYSYMBOL_SPACE_ENTER = 24,               /* SPACE_ENTER  */
  YYSYMBOL_UNDEFINE = 25,                  /* UNDEFINE  */
  YYSYMBOL_DEC = 26,                       /* DEC  */
  YYSYMBOL_HEX = 27,                       /* HEX  */
  YYSYMBOL_OCT = 28,                       /* OCT  */
  YYSYMBOL_ILHEX = 29,                     /* ILHEX  */
  YYSYMBOL_ILOCT = 30,                     /* ILOCT  */
  YYSYMBOL_IDN = 31,                       /* IDN  */
  YYSYMBOL_END_OF_INPUT = 32,              /* END_OF_INPUT  */
...
{
       0,   126,   126,   127,   130,   139,   152,   165,   178,   193,
     206,   219,   232,   245,   258,   273,   286,   299,   314,   327,
     340,   355,   368,   381,   394,   407
};
#endif
...
static const char *const yytname[] =
{
  ...
  "WHILE", "DO", "BEGIN_N", "END", "ADD", "SUB", "MUL", "DIV", "GT", "LT",
  "EQ", "GE", "LE", "NEQ", "SLP", "SRP", "SEMI", "KEY", "SPACE_ENTER",
  "UNDEFINE", "DEC", "HEX", "OCT", "ILHEX", "ILOCT", "IDN", "END_OF_INPUT",
